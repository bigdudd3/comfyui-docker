...
class UnifiedVisionPromptGenerator:
    ...
    def generate_prompt(self, question, max_new_tokens, temperature, seed, model, keep_model_loaded=False, image=None):
...
NODE_CLASS_MAPPINGS = {
    "UnifiedVisionPromptGenerator": UnifiedVisionPromptGenerator
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "UnifiedVisionPromptGenerator": "Unified Vision Prompt Generator"
}